...
| **Metadata** | Sample to Data Relationship Format (.sdrf.tsv) | **Optional** | **Optional** | Comprehensive metadata, highly recommended for all submissions to improve data reusability |
