...
| Ct Data File**                                        |ontains raw cycle threshold (Ct) values from qPCR | CSV, Excel         | Raw **(Recommended)**   |
